...
print(f"\nPearson's Correlation Coefficient between CustomerAge and PurchaseAmount: {correlation:.2f}")
...
Pearson's Correlation Coefficient (CustomerAge vs PurchaseAmount): {:.2f}
""".format(
    age_stats.to_string(),
    purchase_mean,
    purchase_median,
